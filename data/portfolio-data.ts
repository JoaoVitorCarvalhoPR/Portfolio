...
export const careerItems: CareerItem[] = [
 {
  ...
  },
  {
    ...
    organization: "Veryon Imóveis",
    location: "Vila Velha, Espírito Santo",
    startDate: "Jul 2026",
    description: "Built and maintain Vera, a real estate AI assistant on WhatsApp, as a freelance full stack engineer — from the n8n conversational workflow and RAG-based property search to the property data collection service.",
    skills: [
      "Internet Software",
