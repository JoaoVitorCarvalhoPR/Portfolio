      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        {project.externalUrl && (
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 mb-12 border border-border rounded-md text-sm font-medium text-foreground hover:bg-secondary transition-colors"
          >
            View on GitHub
